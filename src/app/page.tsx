...
const FeatureCard = ({
  ...
  <div className="flex flex-col items-center justify-center rounded-lg bg-gray-900 p-6 text-center">
    <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-full bg-purple-900/50">
      {icon}
    </div>
...
const Page = () => {
  return (
    <div className="flex min-h-screen flex-col">
      ...
      {/* Footer */}
      <footer className="border-t border-gray-800 py-8 text-center text-sm text-gray-400 mt-20">
        Coming soon. <br />
